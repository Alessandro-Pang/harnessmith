...
const fingerprintResult = checked(nodeBin, ['--import', 'tsx', join(repository, 'scripts', 'evaluation', 'eval-gate.ts'), 'fingerprint', '--json', '--package-artifact', candidate], { cwd: repository, env: { HARNESS_RELEASE_ARTIFACT: candidate } });
...
checked(
  ...
  [
    '--import',
    'tsx',
    join(repository, 'scripts', 'evaluation', 'eval-gate.ts'),
    'validate',
    '--runs-dir',
    validationDir,
  ],
