...
import type { SearchSource } from '../template/agent-harness/src/lib/search.js';
import { searchBackend } from '../template/agent-harness/src/lib/search-backend.js';
import {
  searchIndexPath,
  searchWithIndex,
} from '../template/agent-harness/src/lib/search-index.js';
import { loadCurrentIndex } from '../template/agent-harness/src/lib/search-index-store.js';
