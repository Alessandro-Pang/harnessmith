...
Kimi Code CLI, DeepSeek Harness, Pi Agent, and WorkBuddy. It manages installation, ownership checks, backups, restore, and uninstall while leaving model execution,
