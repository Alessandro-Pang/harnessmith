...
import {
  capturedIo,
  harnessRuntime,
} from '../../../../packages/harness/src/__tests__/helpers/harness.js';
import { initGlobal } from '../../../../packages/harness/src/commands/init.js';
import { checkpointTask, initTask } from '../../../../packages/harness/src/commands/task/task.js';
import {
  userDataCoordinationTargets as embeddedTargets,
  withUserDataCoordinationLocks as withEmbeddedUserDataCoordinationLocks,
} from '../../../../packages/harness/src/lib/filesystem/user-data-lock.js';
import {
