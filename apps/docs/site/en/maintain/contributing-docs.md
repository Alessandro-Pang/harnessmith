...
submitting documentation PRs; for contributing code to the project, see
[Project contributions](/en/maintain/contributing), and the project's general contribution rules are still defined
by [`CONTRIBUTING.md`](https://github.com/Alessandro-Pang/harnessmith/blob/main/CONTRIBUTING.md) at the repository
root.
