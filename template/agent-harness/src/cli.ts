...
import { registerRepositoryMapCommands } from './program/repository-map/repository-map.js';
import { addSearchOptions, type SearchCommandOptions } from './program/search/search-options.js';
import { registerTaskCommands } from './program/task/task.js';
