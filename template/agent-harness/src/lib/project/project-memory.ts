...
import { gitRoot } from '../filesystem/git.js';
import { withMemoryLock } from '../memory/memory-lock.js';
import { maximumMemoryDocumentBytes } from '../memory/memory-path.js';
import { validateMemoryPreflight } from '../memory/memory-preflight.js';
import {
...
} from '../memory/memory-write.js';
import { assertSafePath, sameCanonicalPath } from '../filesystem/safe-path.js';
import { readTemplate, render } from '../filesystem/templates.js';
