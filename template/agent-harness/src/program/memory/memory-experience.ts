...
} from '../../commands/memory/memory-experience.js';
import {
...
const experiencePayloadSchema = {
  ...
  required: ['kind', 'title', 'conclusion', 'rationale', 'application', 'evidence', 'sourceRefs'],
...
export function registerMemoryExperienceCommand(
  ...
  memory
    ...
    .option('--rationale <text>', 'why the conclusion is reusable')
    .option('--application <text>', 'how to apply the conclusion')
    .addOption(
